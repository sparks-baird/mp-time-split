...
Welcome to `mp-time-split` contributor's guide.
...
If you experience bugs or general issues with `mp-time-split`, please have a look
...
You can help improve `mp-time-split` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`mp-time-split` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `mp-time-split`'s files. While this mechanism can
...
```
conda create -n mp-time-split python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/mp-time-split.git
   cd mp-time-split
   ```
...
5. Install [pre-commit]:
   ...
   `mp-time-split` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/mp-time-split
[issue tracker]: https://github.com/<USERNAME>/mp-time-split/issues
